    ...
    <aside className="w-[220px] shrink-0 h-screen flex flex-col brutal-border-r bg-brutal-cream overflow-hidden">
              ...
              return (
                <Link
                  ...
                  className={`relative flex items-center gap-3 mx-2 px-2 py-2.5 mb-0.5 border-2 border-brutal-ink font-display font-bold text-[13px] transition-all ${
                    active
                      ? 'bg-brutal-blue text-white shadow-brutal-sm -translate-x-0.5 -translate-y-0.5'
      ...
      <div className="mx-3 mb-3 brutal-border brutal-shadow-sm bg-brutal-surface">
        ...
        <div className="grid grid-cols-2">
          <Link href="/profile" className="py-2 text-center font-display font-bold text-[10px] tracking-[0.16em] uppercase brutal-border-r hover:bg-brutal-yellow transition-colors flex items-center justify-center gap-1">
